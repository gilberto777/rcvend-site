          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-100 min-h-[600px] overflow-hidden">
            <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
              <div className="border-b border-gray-100 bg-white">
                <TabsList className="w-full justify-start h-auto bg-transparent px-3 py-2 gap-2 overflow-x-auto flex-nowrap">
                  <TabsTrigger 
                    value="properties" 
                    className="px-4 py-3 rounded-md text-gray-600 font-medium transition-all whitespace-nowrap data-[state=active]:text-[#1a3a52] data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-[#0d5a7a]"
                  >
