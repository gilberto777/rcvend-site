            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 text-center">
                  ...
                  <a href="tel:+5511970259728" onClick={handlePhoneAction} className="mt-4 flex items-center justify-center text-gray-600 hover:text-[#0d5a7a] transition-colors font-semibold text-lg">
                     <Phone className="w-5 h-5 mr-2" /> (11) 97025-9728
                  </a>
                </div>
