...
export const AuthProvider = ({ children }) => {
  ...
  const handleUserSession = async (currentUser) => {
    try {
      ...
      console.error('[Auth] Failed to load/create broker profile:', {
      ...
      toast({
        ...
        description: devDetails
          ? `Houve um problema ao carregar seu perfil de corretor. Detalhes: ${devDetails}`
          : "Houve um problema ao carregar seu perfil de corretor. Tente recarregar a página.",
        variant: "destructive"
      });
    }
  };
