...
export const generatePropertyDescription = (property) => {
  ...
  return `Confira este imóvel para ${typeLabel} em ${property.neighborhood}, SP. ${bedrooms} quartos, ${area}m². Valor: ${prefix}${priceFormatted}. Agende sua visita agora com a Radar.`;
};

// Kept for backward compatibility if used elsewhere, but new logic is in generatePropertySchema.js
export const generateRealEstateSchema = (property, baseUrl = 'https://rcvend.com.br') => {
