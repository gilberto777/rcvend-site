...
const SiteSettings = () => {
  ...
  const [settings, setSettings] = useState({
    site_name: 'Radar',
    site_description: '',
    contact_email: 'radar.consultoriaimoveis@gmail.com',
    contact_phone: '11970259728',
    whatsapp_number: '11970259728',
    company_address: ''
  });
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a3a52] outline-none"
              placeholder="radar.consultoriaimoveis@gmail.com"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#1a3a52] outline-none"
              placeholder="5511970259728"
            />
            <p className="text-xs text-gray-500 mt-1">5511970259728 (ex: 5511...)</p>
          </div>
